...
export default function AppReducer(state = defaultState, action) {
	...
	switch (action.type) {
		case ActionTypes.UPDATE_STATE_APP:
			return { ...state, ...action.body };

		case ActionTypes.SET_PROFILE:
			return { ...state, profile: action.body };
		case ActionTypes.SET_DEVICE:
			return {
				...state,
				device:
					action.body && action.body.protocol ? action.body : null,
				orientation: action.body ? action.body.orientation : null,
			};
		...
		case ActionTypes.MODAL_SHOW: {
			...
			else console.warn("openDialog duplicate: " + name);
		...
		case ActionTypes.WIZARD_HIDE:
			return {
				...state,
				wizardType: undefined,
				wizardStep: undefined,
			};
		case ActionTypes.WIZARD_SET_STEP:
			return { ...state, wizardStep: action.body };

		case ActionTypes.SET_LANGUAGE:
			return { ...state, language: action.body };
		case ActionTypes.SET_SETTINGS_TAB_INDEX:
			return { ...state, settingsTabIndex: action.body };

		case ActionTypes.UPDATE_DOWNLOAD_PROGRESS:
			return { ...state, downloadProgress: action.body };
