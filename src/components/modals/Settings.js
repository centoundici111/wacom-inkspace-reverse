...
class Settings extends Component {
	...
	render() {
		...
		return (
			<div
				className={"dialog-wrapper flex-wrapper " + this.props.modal}
			...
			>
				...
				>
					<div className="dialog-content">
						<Tabs
							selectedIndex={this.props.settingsTabIndex}
							onSelect={this.props.selectSettingsTab}
						>
							<TabList>
								<Tab
									disabled={disabled}
								...
								>
									<FormattedMessage id="settings.tab.device" />
								</Tab>
								<Tab
									disabled={disabled}
									disabledClassName="disabled"
								>
									<FormattedMessage id="settings.tab.inkspace" />
								</Tab>
								<Tab
									disabled={disabled}
									disabledClassName="disabled"
								>
									<FormattedMessage id="settings.tab.support" />
								</Tab>
								<Tab>
									<FormattedMessage
...
function mapDispatchToProps(dispatch) {
	return bindActionCreators(
		{ ...actions, addNotification, signOut },
		dispatch
	);
}
