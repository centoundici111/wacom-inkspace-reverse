...
class DownloadNotesProgress extends Component {
	...
	componentDidUpdate(prevProps, prevState) {
		if (prevProps.total == 0) {
			if (this.props.total > 0) this.setState({ hidden: false });
				...
				>
					<div className="progress-inner">
						...
						<div className="progress-message">
							...
							/>
							{(() =>
								DeviceManager.transportProtocol ==
								SmartPadNS.TransportProtocol.USB ? (
									<span>
										<FormattedMessage
											id={
												"notification.do.not.unplug.device"
											}
										/>
									</span>
								) : null)()}
