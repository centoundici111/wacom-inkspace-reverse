				...
				<ul>
					...
					<li>
						<span className="cloud-left ink-blue">
							<a onClick={() => UIManager.openExternal("http://www.wacom.com/products/apps-services/inkspace")}>
					...
					*/}
					...
					<li>
						<span className="cloud-left ink-blue">
							<a onClick={() => UIManager.openExternal("https://www.wacom.com/getting-started/wacom-intuos-pro-paper-edition")}>
					...
					*/}
					<li>
						<span className="cloud-left ink-blue">
							<a onClick={() => UIManager.openExternal("http://www.wacom.com/products/apps-services")}>
