							...
							<ul>
								...
								*/}
								...
								<li className="has-select-list">
									<span className="cloud-left">
										<FormattedMessage
											id={"exportAsText.language"}
										/>
									</span>
									<LanguageMenu
										name="default-note-language"
										export={true}
										updateDefault={true}
										classNames="lang-select cloud-right"
									/>
								</li>
								{/*
								<li>
						...
						if (this.props.online) {
							return (
								<ul>
									<li>
										<a
											className="cloud-left ink-blue hide"
											onClick={::this.openAccount}
										>
											<FormattedMessage
												id={"settings.inkspace.account"}
											/>
										</a>
									</li>
									<li>
						...
						return (
							<ul>
								<li>
									<span className="cloud-left">
										<FormattedMessage
											id={"settings.inkspace.notlogged"}
										/>
									</span>
								</li>
								{(() => {
