...
class EditNote extends Component {
  constructor(props) {
    ...
    Object.defineProperty(this, "refreshLayerPreview", {
      value: utils.debounce(
        () => this.props.updatePreview(this.props.currentLayer),
        100
      ),
    });
  ...
  componentDidMount() {
    ...
    if (this.props.activeTool) WILL.setTool(WILL.tools[this.props.activeTool]);
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(ReactUtils.createParentTracker(EditNote));
